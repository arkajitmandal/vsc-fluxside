...
def init(param):
    ...
    ωb = 0.004556335 # 1000 cm-1
    Eb = 0.01822534  # 2250 cm-1
    a =  ωb**4/(16*Eb) #/10.0
    b = -ωb**2/2 #/10.0
    
    
    x[0]  =  -(-b/(2 * a))**0.5 +    σx[0]     # Nuclear DOF
    
    
    c  = param.χ * (2.0 /param.ωc**3.0)**0.5 
    x[1]  = gran(0, σx[1]) - c * x[0] # Cavity DOF 
